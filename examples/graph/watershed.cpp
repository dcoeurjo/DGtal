...
int main()
{
  ...
  Image image(domain);
  image.setValue(Point(0,0), 1); image.setValue(Point(1,0), 1); 
  image.setValue(Point(2,0), 2); image.setValue(Point(3,0), 1); 
  image.setValue(Point(4,0), 1); image.setValue(Point(0,1), 1); 
  image.setValue(Point(1,1), 1); image.setValue(Point(2,1), 2); 
  image.setValue(Point(3,1), 1); image.setValue(Point(4,1), 1);
  image.setValue(Point(0,2), 4); image.setValue(Point(1,2), 1);
  image.setValue(Point(2,2), 2); image.setValue(Point(3,2), 1); 
  image.setValue(Point(4,2), 1); image.setValue(Point(0,3), 1);
  image.setValue(Point(1,3), 1); image.setValue(Point(2,3), 3); 
  image.setValue(Point(3,3), 2); image.setValue(Point(4,3), 1);
  image.setValue(Point(0,4), 1); image.setValue(Point(1,4), 1);
  image.setValue(Point(2,4), 4); image.setValue(Point(3,4), 1); image.setValue(Point(4,4), 3);
